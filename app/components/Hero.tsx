    ...
    return (
        <div className="containers max-w-screen-xl h-[100vh] w-full flexCenter">
            <div className="flexColCenter">
                ...
                initial="hidden"
                animate="show"
                className="text-center text-[4.5rem] max-[600px]:text-[2.5rem] max-[470px]:text-[2rem] font-bold sm:leading-none leading-[0.8] title-style">We build brands, <br /> we create experiences.</motion.h1>
                <motion.p 
                variants={items}
                initial="hidden"
                animate="show"
